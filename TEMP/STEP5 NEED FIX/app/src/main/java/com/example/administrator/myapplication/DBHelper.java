...
import com.example.administrator.myapplication.Model.Category;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private final String INPUT_DATA_DEPT_1 =
            "INSERT INTO " + Table_Categories +
                    ...
                    "VALUES" +
                    "(" + "'department', '1001', '컴퓨터소프트웨어과', 'bulitin'" + ")";
    ...
    private final String INPUT_DATA_DEPT_2 =
            "INSERT INTO " + Table_Categories +
                    ...
                    "grp, code, codekor, caption" + ")" +
                    "VALUES" +
                    "(" + "'department', '2001', '실내디자인과', 'bulitin'" + ")";
    ...
    //update문 (크레인)
    public Student InsertORUpdate(String num, String name, String phone, String imagename,
                                  String department){
        //입력한 기본키에 따라 정보 불러옴.
        //select(num);
