...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private com.example.administrator.myapplication.app.AppDate AppDate = new AppDate();
    ...
    private final String INIT_CODE_UNIV_STUCLASS_1 =
            "INSERT INTO " + Table_Codes +
                    "("  +
                    "grp, code, code_kor, descript, creation_date" + ")" +
                    "VALUE" +
                    "(" + "'stu_class', '1001', '컴퓨터소프트웨어괴','initial','" +  AppDate.getTodayDayTimeDate()+ "'" +")";
    //String 형이기 떄문이 " " 포함;
